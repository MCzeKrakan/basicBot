...
/*
    ...
    */
    ...
    var menuButton = $('<div id="car" class="header-panel-button" style=""><i class="icon" style="top: 13px; width: 42px; height: 25px; background: url(http://oi59.tinypic.com/2hwl34h.jpg);"></i></div>');
