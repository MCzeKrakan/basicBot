...
/*
    ...
    */
    ...
    var menuButton = $('<div id="car" class="header-panel-button" style=""><i class="icon" style="top: 13px; width: 50px; height: 30px; background: url(http://i62.tinypic.com/11rx7v6.jpg);"></i></div>');
