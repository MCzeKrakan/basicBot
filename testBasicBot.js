...
/*
    ...
    */
    ...
    var menuButton = $('<div id="car" class="header-panel-button" style=""><i class="icon" style="top: 13px; width: 26px; height: 27px; background: url(http://oi62.tinypic.com/nmx4x0.jpg);"></i></div>');
