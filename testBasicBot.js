...
/*
    ...
    */
    ...
    var menuButton = $('<div id="car" class="header-panel-button" style=""><i class="icon" style="top: 13px; width: 42px; height: 25px; background: url(http://i57.tinypic.com/2e2kyfq.jpg);"></i></div>');
