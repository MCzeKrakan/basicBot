...
/*
    ...
    */
    ...
    var menuButton = $('<div id="car" class="header-panel-button" style=""><i class="icon" style="top: 11px; width: 59px; height: 35px; background: url(http://oi62.tinypic.com/nmx4x0.jpg);"></i></div>');
