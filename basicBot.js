        ...
        /*              alternative history time skip
            ...
            for (var i = 0; i < basicBot.room.historyList.length; i++) {
                if (basicBot.room.historyList[i][0] === obj.media.cid) {
                    ...
                    if (basicBot.settings.historySkip && (lastPlayedTime < repeatLimit) && (lastPlayedTime > 5000)) {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        if (permUser === 0) {
                             ...
                             */
                            if (time > 45) {
                                API.sendChat(subChat(basicBot.chat.mutedtime, {name: chat.un, username: name}));
            ...
            statusCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        msg2 += basicBot.chat.lockskip + ': ';
                        if (basicBot.settings.lockskip) msg2 += 'ON';
                        else msg2 += 'OFF';
                        msg2 += ' | ';

                        msg2 += basicBot.chat.historyskip + ': ';
                        if (basicBot.settings.historySkip ) msg2 += 'ON';
                        else msg2 += 'OFF';
                        msg2 += ' (' + basicBot.settings.historySkipLimit + ') | ';
                        // alterative history time skip
                        //msg2 += basicBot.chat.historylimit + ': ' + basicBot.settings.historyLimitTime + ' |  ';
            ...
            swapCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat(subChat(basicBot.chat.swapping, {name: chat.un, 'name1': name1, 'name2': name2}));
                        if (p1 < p2) {
