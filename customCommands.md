...
|!lockskip | (důvod) | přeskočí píseň a posune dj zpět na první místo (důvody: theme - Song nevyhovuje aktuálnímu žánru této místnosti. op - Song je na seznamu příliš často hraných. history - Song je již v historii. sound - Song má velmi špatnou kvalitu zvuku, nebo žádný zvuk. nsfw - Song obsahuje nevhodný obsah (obrazový nebo zvukový). un - Song nebyl dostupný pro všechny uživatele.) |
